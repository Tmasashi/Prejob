...
Income.create(:price_band => '１～９９９円')
Income.create(:price_band => '１０００～１９９９円')
Income.create(:price_band => '２０００～２９９９円')
Income.create(:price_band => '３０００円～')

Term.create(:time_period => '～１カ月')
Term.create(:time_period => '１～３カ月')
Term.create(:time_period => '３～６カ月')
Term.create(:time_period => '６～９カ月')
Term.create(:time_period => '９～１２カ月')
Term.create(:time_period => '１２カ月～')

WorkingDay.create(:number => 3)
WorkingDay.create(:number => 4)
WorkingDay.create(:number => 5)
WorkingDay.create(:number => 6)
